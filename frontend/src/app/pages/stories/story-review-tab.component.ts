...
@Component({
  ...
  styles: [`
    ...
    .story-review-layout{--b:1px solid var(--color-border);display:grid;grid-template-columns:320px 1fr;min-height:30rem;border:var(--b);border-radius:var(--radius-lg);background:var(--color-surface-1);overflow:hidden}
    ...
    .review-case-item:hover{background:var(--color-surface-1);transform:translateX(2px)}
    ...
    .case-meta-badge{display:inline-flex;align-items:center;min-height:1.65rem;padding:0 .55rem;border:var(--b);border-radius:var(--radius-sm);background:var(--color-surface-2);color:var(--color-text-2);font-family:var(--font-mono);font-size:.72rem;font-weight:500}
    .review-detail-panel{position:relative;display:grid;align-content:start;gap:var(--space-lg);min-width:0;min-height:30rem;padding:var(--space-xl);background:var(--color-surface-1)}
    ...
    .review-sticky-actions{position:sticky;bottom:0;display:flex;align-items:center;justify-content:space-between;gap:var(--space-base);margin:var(--space-lg) calc(var(--space-xl) * -1) calc(var(--space-xl) * -1);padding:var(--space-md) var(--space-lg);border-top:1px solid var(--color-border);background:var(--color-surface-1);z-index:var(--z-sticky)}
