...
@Component({
  ...
  styles: [`
    ...
    .filter-chip { display: inline-flex; align-items: center; gap: var(--space-xs); background: var(--glass-bg-1); border: 1px solid var(--glass-edge); border-radius: 9999px; padding: var(--space-xs) var(--space-sm); color: var(--color-text); font-family: var(--font-mono); font-size: 0.75rem; }
    ...
    .filter-select, .filter-input { background: var(--glass-bg-1); color: var(--color-text); border: 1px solid var(--glass-edge); border-radius: var(--radius-md); padding: 0.45rem 0.55rem; font-size: 0.85rem; min-width: 160px; }
